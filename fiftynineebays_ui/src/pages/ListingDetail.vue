					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateListing()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Listings = true">Add</base-button>
								              <modal :show.sync="modal2Listings">
								  ...
								  <base-input label="Price" type="text" placeholder="Enter Price" v-model="listingToAdd.price"></base-input>
												                  </form>
								                </div>
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Listing Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ListingId" type="text" placeholder="Enter ListingId" v-model="listingDetails.listingId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Title</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Title" type="text" placeholder="Enter Title" v-model="listingDetails.title"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Description</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Description" type="text" placeholder="Enter Description" v-model="listingDetails.description"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Price</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Price" type="text" placeholder="Enter Price" v-model="listingDetails.price"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateListing() {
      ...
      const jsonData = JSON.stringify(this.listingDetails);
      const res = await ListingService.update(jsonData);
